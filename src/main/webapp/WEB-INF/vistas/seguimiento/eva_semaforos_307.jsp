...
<html lang="en">
    ...
    <body class="hold-transition skin-blue layout-top-nav">        
            ...
            <div class="col-md-12">                
                ...
                <div class="col-md-2">                    
                    <div class="margin text-right">
                        <div class="btn-group">
                            <a class="btn btn-default active" href="${semaforos_detalle}" title="Semáforos y detalle de actividades">                            
            ...
            <div class="col-md-12">                
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <!--<span class="pull-right text-blue text-sm">Última fecha de actualización:&nbsp;</span>-->
                    </div>                    
                    <div class="panel-body">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12" title="SEMÁFORO DE MICROVIDEOS">
                            <div class="info-box border-right" id="semaforoGeneralMicroVideos">
                                ...
                                <div class="info-box-content">
                                    <span class="info-box-text text-bold">MICROVIDEOS</span>
                                    <p>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="panel_cabecera">
                        ...
                        <h5 class="text-center" id="mensajeActividadGeneral"></h4>
                            ...
                            <!--<table class="table table-bordered table-responsive" id="tabla_cabecera_actividades"></table>-->
                    </div>
                </div>
            </div>
        ...
        <!-- Eva -->
        <script src="<c:url value="/recursos/app/js/eva/eva_semaforos_307.js" />"></script>                                          
