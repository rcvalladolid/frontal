                ...
                <section class="content">
                    <div class="error-page">
                        ...
                        <div class="error-content">
                            <h3><i class="fa fa-warning text-yellow"></i> HTTP Status 500 - Error en el servidor!!!.</h3>
                            <p>
                                Estimado <strong>${usuario.usuUsername}</strong>, ha currido un problema en nuestro servidor.                                                                
                            </p>     
                            <br>
                            <form class="search-form">
                                <div class="input-group">                                    
                                    Puedes <a href="<c:url value="/logout" />">salir de la página</a>                                                       
                                </div>
                            </form>
                            <p>
